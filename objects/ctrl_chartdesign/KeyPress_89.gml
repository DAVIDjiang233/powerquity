...
if (designview==0||designview==-1){
	...
	array_copy(global.chartread, 0,global.cancelchart[cancelchartlist], 0, array_length(global.cancelchart[cancelchartlist]));
...
if (designview==1){
	if(cancelsvlist+1>=array_length(global.cancelsv)) exit;
	cancelsvlist++;
