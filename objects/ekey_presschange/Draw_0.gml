...
draw_rectangle(x-48,-1,x+47,608-power(endtime-global.playtime,3)/19000000,false);
...
draw_rectangle(x-48,-1,x-42,608-power(endtime-global.playtime,3)/19000000,false);
draw_rectangle(x+41,-1,x+47,608-power(endtime-global.playtime,3)/19000000,false);
draw_set_alpha(1)
...
if changebar=="4" draw_set_colour(#0000ff);
draw_rectangle(x-48,y-12,x+47,y,false);
